...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [CL] = LAYOUT(
      ...
      KC_TAB,       LT(NM_MODE,KC_Q),    KC_W,    LT(ACCENT,KC_F),    KC_P,    KC_G,    KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN,     KC_LBRC, KC_RBRC, KC_BSPC,
      MT(MOD_LCTL,KC_BSPC),      KC_A,    KC_R,    KC_S,    LT(BRCKS, KC_T),    KC_D,    KC_H,    LT(BRCKS, KC_N),    KC_E,    KC_I,    KC_O,           KC_QUOT, KC_ENT,
      ...
      _______, KC_LGUI,                     TD(ALT_NM),              		KC_SPC,    LM(CL,MOD_LGUI|MOD_LALT), OSL(ACCENT)    , _______
      ),
  [NM_MODE] = LAYOUT(
  ...
  [ACCENT] = LAYOUT(
      ...
      _______,         RGB_TOG,    RGB_MODE_PLAIN,  RGB_LYR,    RGB_MOD,    _______,    _______,    _______,    DE_UE,    _______,    _______,     _______, _______, _______,
      ...
      _______,             EPRM,         _______,            _______,         _______, _______,  _______
      ),
};
