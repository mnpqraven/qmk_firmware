...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   //         KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RESET, KC_DEL,
  ...
  [CL] = LAYOUT(
      ...
      _______, TG(BRCKS),                     TD(ALT_NM),            _______,	KC_SPC, _______,   LM(CL,MOD_LGUI|MOD_LALT), OSL(ACCENT)    , _______, _______
      ),
  [NM_MODE] = LAYOUT(
  ...
  [ACCENT] = LAYOUT(
      ...
      KC_LSFT,   _______,  _______,  _______, _______,      _______,    _______,    _______,    _______,    _______,    _______,        _______, _______, TO(CL),
