...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [CL] = LAYOUT(
      AC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,        KC_EQL,     KC_BSLS,    KC_DEL,
      ...
      LGUI(KC_SPC),    TD(GUI_NM),         TD(ALT_NM),         _______,         KC_SPC,    _______,      LM(CL,MOD_LGUI|MOD_LALT), OSL(ACCENT),  _______,  TT(VI_MODE), LM(CL,MOD_LGUI|MOD_LSFT)
      ),
  [NM_MODE] = LAYOUT(
