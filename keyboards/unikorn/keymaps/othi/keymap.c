...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [GAME] = LAYOUT_all(
    ...
    KC_LCTL,          KC_LGUI, KC_LALT,         KC_SPC,    LCTL(KC_SPC),      KC_BSPC,       KC_LALT, LGUI(KC_SPC), KC_TRNS,  TO(CL)
  ),
  ...
  [NM_MODE] = LAYOUT_all(
    ...
    KC_TRNS, KC_LEFT, KC_TRNS,       KC_RGHT, KC_TRNS, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT, KC_TRNS, KC_ENT,  KC_TRNS, KC_TRNS, LCTL(KC_ENT),
  ...
  [ACCENT] = LAYOUT_all(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, DE_UE,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, DE_AE,   KC_TRNS, DE_SS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, DE_OE,   KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_TRNS, UC_M_LN, UC_M_WI, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, RESET, KC_TRNS,
    KC_TRNS, KC_TRNS, KC_TRNS,         KC_SPC,    KC_SPC,      KC_SPC,               KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS
  ),
};
